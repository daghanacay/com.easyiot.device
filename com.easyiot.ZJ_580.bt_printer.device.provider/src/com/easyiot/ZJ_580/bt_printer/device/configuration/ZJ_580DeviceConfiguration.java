...
@ObjectClassDefinition(name = "ZJ_580 blutooth printer device configuration")
public @interface ZJ_580DeviceConfiguration {

	/**
	 * Id of the device instance
	 */
	@AttributeDefinition(name = "ZJ_580 device ID", description = "ZJ_580 device instance ID", required = true)
